...
# Add parent directory to path to import project_setup
parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.insert(0, parent_dir)
from prompt-engineering-lab.project_setup import setup_project
...
class TestProjectSetup(unittest.TestCase):
    ...
    def test_setup_project_success(self, mock_print, mock_exists, mock_import_gtfs):
        ...
        mock_exists.assert_called_once_with("group-task-skeleton/OtwartyWroclaw_rozklad_jazdy_GTFS")
    ...
    def test_setup_project_missing_gtfs_folder(self, mock_print, mock_exists, mock_exit):
        ...
        mock_exists.assert_called_once_with("group-task-skeleton/OtwartyWroclaw_rozklad_jazdy_GTFS")
        mock_print.assert_any_call("Error: GTFS folder not found at group-task-skeleton/OtwartyWroclaw_rozklad_jazdy_GTFS")
