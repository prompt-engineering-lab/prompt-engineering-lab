...
import os
import tempfile
from prompt-engineering-lab.import_to_db import create_table_from_csv, insert_csv_to_table
...
class TestGTFSImport(unittest.TestCase):
    ...
    def test_create_table_from_csv(self):
        ...
        csv_path = "group-task-skeleton/OtwartyWroclaw_rozklad_jazdy_GTFS/stops.txt"
    ...
    def test_insert_csv_to_table(self):
        ...
        csv_path = "group-task-skeleton/OtwartyWroclaw_rozklad_jazdy_GTFS/agency.txt"
        if not os.path.exists(csv_path):
